...
setup_mysql_config () {
    ...
    echo -e "login_server_db: ${MYSQL_DATABASE}" >> /opt/rAthena/conf/import/inter_conf.txt
    ...
    echo -e "map_server_db: ${MYSQL_DATABASE}" >> /opt/rAthena/conf/import/inter_conf.txt
    ...
    echo -e "char_server_db: ${MYSQL_DATABASE}" >> /opt/rAthena/conf/import/inter_conf.txt
    ...
    echo -e "ipban_db_db: ${MYSQL_DATABASE}" >> /opt/rAthena/conf/import/inter_conf.txt
    ...
    echo -e "log_db_db: ${MYSQL_DATABASE}" >> /opt/rAthena/conf/import/inter_conf.txt
    ...
    if ! check_database_exist; then
        ...
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/main.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/logs.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/item_db.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/item_db2.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/item_db_re.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/item_db2_re.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/item_cash_db.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/item_cash_db2.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_db.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_db2.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_db_re.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_db2_re.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_skill_db.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_skill_db2.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_skill_db_re.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/mob_skill_db2_re.sql
        mysql -u${MYSQL_USER} -p${MYSQL_PASSWORD} -h ${MYSQL_HOST} -D${MYSQL_DATABASE} < /opt/rAthena/sql-files/roulette_default_data.sql
